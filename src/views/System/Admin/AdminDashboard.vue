    ...
    navItems() {
      return [
        ...
        },
        {
          key: 'notifications',
          label: 'Notificações',
          description: 'Enviar e gerenciar notificações',
          icon: this.icons.notifications,
          routeName: 'admin-notifications',
        },
        {
          key: 'fee-config',
          label: 'Configuração de Taxa',
          description: 'Configurar tipo e valor da taxa',
          icon: this.icons.feeConfig,
          routeName: 'admin-fee-config',
        },
        {
          key: 'revenue',
          label: 'Receita',
          description: 'Acompanhar receita do sistema',
